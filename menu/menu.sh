...
export sem=$( curl -s https://raw.githubusercontent.com/NevermoreSSH/Vergil/main/permission/versions)
...
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( todfix667 )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │         ${BIWhite}${UWhite}todfix667 TUNNELING${NC}     ${BICyan}│${NC}"
echo -e "${BICyan} │                                                     │${NC}"
